...
protected:
    ...
    GLuint m_bufIdxT; // A Vertex Buffer Object that we will use to store triangle indices for transparent objects (GLuints)
    ...
    bool m_idxGeneratedT;
    bool m_posGenerated;
    bool m_norGenerated;
    bool m_colGenerated;

    bool m_verGeneratedO;
    bool m_verGeneratedT;
